...
const About = () => {
  return (
    <div className="container">
      ...
      <div className="py-4">
        <h1 class="m-10 text-center display-1 font-weight-bold">About page</h1>
        <div class="row">
          <div class="col-sm-6">
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Go somewhere</a>
        ...
        Like those conscription adverts about being from Carlisle but finding your true self on a nuclear sub in the Caspian Sea, Bell & Ross was made in the forces. The French air force, to be exact, with the marque supplying function-led pilot watches since its formation in 1992. That date makes Bell & Ross a toddler by luxury watch manufacture standards, but in its short life it's proved itself something of a horological prodigy. Now, the French-born Swiss-made outfit is landing hi-spec technicality on terra firma, with a brand new release: the BR 05 Chrono Black Steel.

bell  ross br 05
BR 05 (£5,200) at bellross.com
BELL & ROSS
